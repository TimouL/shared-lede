...
#修改主机名
sed -i 's/OpenWrt/Xiaomi-R4A/g' package/base-files/files/bin/config_generate
#修改型号显示
...
#设置WIFI
#sed -i 's/OpenWrt/TimOu1001/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
